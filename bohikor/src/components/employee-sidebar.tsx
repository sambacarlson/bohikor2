...
export function EmployeeSidebar() {
  ...
  const navItems = [
    ...
    { href: `/${company}/history`, label: "History", icon: History },
    { href: `/${company}/account`, label: "Account", icon: User },
  ];
  ...
  return (
    ...
    >
      <Link
        href={`/${company}`}
        className={cn("flex h-16 items-center gap-2 border-b border-sidebar-border px-4")}
      >
        <Image src="/logo.png" alt="Bohikor" width={26} height={26} className="shrink-0 rounded-md" />
        {!collapsed && (
